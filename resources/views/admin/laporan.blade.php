...
<div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
    ...
    <div class="flex flex-wrap justify-between items-center gap-4 mb-6">
        ...
        <!-- Filter Tanggal -->
        <form action="{{ route('admin.laporan') }}" method="GET" class="flex flex-wrap items-center gap-2">
            ...
            <a href="{{ route('admin.laporan') }}" class="px-4 py-2 bg-slate-100 text-slate-600 rounded-lg text-sm hover:bg-slate-200">
                Reset
            </a>
        </form>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {{ $trnsk->transaction_date->format('d-m-Y H:i:s') }}
                    </td>
